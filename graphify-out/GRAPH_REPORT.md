...
## Corpus Check
- 210 files · ~73,378 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 859 nodes · 2214 edges · 42 communities (41 shown, 1 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4819310`
...
8. `ServiceDetails()` - 16 edges
9. `MapDrawer()` - 15 edges
...
Cohesion: 0.15
Nodes (7): ServiceType, KnownService, registry, ServiceRegistry, LoadRow, { queryMock }, useResource()
...
Cohesion: 0.12
Nodes (18): BackIcon(), ChevronIcon(), CommunityGraphIcon(), FitIcon(), FlowGraphIcon(), ResetLayoutIcon(), SettingsIcon(), ThemeIcon() (+10 more)
...
Cohesion: 0.06
Nodes (48): SeriesPoint, errLevel(), rangeEdgeLabels(), BAR_COLORS, ChartGrid(), LEGEND, HEADERS, OperationsTable() (+40 more)

### Community 10 - "Web Dependencies"
Cohesion: 0.16
Nodes (10): api, ErrorBreakdown, ServiceDetail, ServiceList, TraceDetail, TraceListItem, CloseIcon(), EditServiceModal() (+2 more)

### Community 11 - "Form Controls & Filters"
Cohesion: 0.19
Nodes (14): Team, Combobox(), TeamFilter(), TeamChips(), ComboOption, filterOptions(), OPTS, matchesTeamFilter() (+6 more)
...
Cohesion: 0.21
Nodes (11): ForceGraph(), Palette, buildForceLinks(), buildForceNodes(), nodeRadius(), buildDimmer(), dotAlphaScale(), CommunityEdge (+3 more)
...
Cohesion: 0.14
Nodes (19): OperationErrors, HoverSync(), HoverSyncContext, HoverSyncValue, TopErrors(), Card(), DepRow(), DrawerHeader() (+11 more)

### Community 17 - "OTLP Ingest & Normalization"
Cohesion: 0.13
Nodes (21): GroupExpandIcon(), LayeredMap(), TeamFrameBar(), TeamFrameBox(), buildEdgeViews(), GraphModeToggle(), IsolateBanner(), Legend() (+13 more)
...
Cohesion: 0.19
Nodes (17): NeighborEdge, TraceSpan, NodeCard(), EdgeLabelLayer(), KpiCards(), NeighborsPanel(), HEADERS, TracesPanel() (+9 more)
...
Cohesion: 0.18
Nodes (14): config, migrate(), MIGRATIONS_DIR, main(), NormalizedMetricPoint, NormalizedResourceSpans, NormalizedSpan, edgeCounts (+6 more)
...
Cohesion: 0.19
Nodes (18): ServiceListItem, App(), TopBar(), FooterButton(), MapView(), HEADERS, ServicesPage(), WallboardDrawer() (+10 more)
...
Cohesion: 0.19
Nodes (17): attrStr(), DB_SYSTEM_TYPE, hostLabel(), hostOf(), inferOwnType(), inferPeer(), MESSAGING_TYPE, regionOf() (+9 more)

### Community 39 - "status.ts"
Cohesion: 0.32
Nodes (7): SloRing(), StatusPill(), ForceLegend(), ServiceHeader(), sloView, stColor(), stLabel()

### Community 40 - "TopologyService"
Cohesion: 0.16
Nodes (9): ErrorCount, LiveMetrics, Topology, TopologyEdge, TopologyService, serviceMeta(), serviceRelations(), toggleCardSelection() (+1 more)

### Community 43 - "serviceRank.ts"
Cohesion: 0.14
Nodes (11): Status, LogoIcon(), SearchIcon(), HealthPopover(), STATUS_NOUN, servicesByStatus(), SERVICES, UnhealthyService (+3 more)
...
- **Why does `span()` connect `ServicePage.tsx` to `timerange.ts`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `ingestTraces()` connect `ServicePage.tsx` to `preferences.ts`, `OTLP Protobuf Codec`, `Server Error Aggregation API`?**
  _High betweenness centrality (0.188) - this node is a cross-community bridge._
- **Why does `walk()` connect `Sim HTTP & Metrics Emitter` to `Force Graph & Dimming`, `Simulated Error Catalog`, `Sim Trace Payloads`, `timerange.ts`?**
